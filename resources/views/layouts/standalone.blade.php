...
<head>
    ...
    <!-- Stylesheets -->
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,300,400,400i,800" rel="stylesheet">
        ...
        <div>
            <div class="container-xs mx-auto">
                <div class="grid-row text-center">
                    <div class="col-12">
                        <h1>Install Amaranth</h1>
                    </div>
                    <div class="col-12">
                        <footer>
                            <small class="text-grey-light text-center p-2 d-block">Copyright &copy. Ollie Ford & Co. All
                                rights reserved.
                            </small>
                        </footer>
                    </div>
